 ...
 *
 * @author    Varun Sridharan <ahmedguesmi.sb@gmail.com>
 * @copyright 2018 Varun Sridharan
 * @license   GPLV3 Or Greater
 */

namespace ahmedguesmi\WordPress;

if ( ! class_exists( '\ahmedguesmi\WordPress\Endpoint' ) ) {
	/**
	 * Class Endpoint
	 *
	 * @package ahmedguesmi\WordPress
	 * @author Varun Sridharan <ahmedguesmi.sb@gmail.com>
	 * @since 1.0
	 */
	class Endpoint {
